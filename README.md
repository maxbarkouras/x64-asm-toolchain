...
- Compile with: ```nasm -f win64 mipsAssembler.asm -o mipsAssembler.obj```
- Link object file with: ```link /entry:_start /subsystem:windows mipsAssembler.obj /nodefaultlib```
